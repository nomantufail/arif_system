...
<div id="page-wrapper" class="whole_page_container">
    ...
    <div class="container-fluid">
        ...
        <div class="row actual_body_contents">
            ...
            <!--SEARCH AREA FOR tanker LEDGERS-->
            <div class="col-lg-12">
                <form action="" method="get">
                    <table class="search-table" style="width:100%;">
                        <tr>
                            <td style="width: 20%;"><b>tanker: </b><br>
                                <select name="tanker" class="select_box">
                                    <option value="">--All--</option>
                                    <?php foreach($tankers as $tanker): ?>
                                        <?php
                                        $selected = ($tanker->number == $selected_tanker)?'selected':'';
                                        ?>
            ...
            <div class="col-lg-12">
                ...
                ?>print">
                    ...
                    <table class="my_table list_table table table-bordered" style="font-size:12px;">
                        ...
                        <tr>
                            <td colspan="10" style="text-align: right;">Opening Balance: <?= (($opening_balance < 0)?"(".($opening_balance*-1).")":$opening_balance) ?></td>
                        </tr>
