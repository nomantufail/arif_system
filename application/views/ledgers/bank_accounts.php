            ...
            <div class="col-lg-12">
                <form action="" method="get">
                    <table class="search-table" style="width:100%;">
                        <tr>
                            <td style="width: 30%;"><b>Bank Accounts: </b><br>
                                <select name="ac_title" class="select_box">
                                    <option value="">--All--</option>
                                    <?php foreach($bank_accounts as $account): ?>
                                        <?php
                                        $selected = ($account->formatted_title == $ac_title)?'selected':'';
                                        ?>
                                        <option value="<?= $account->formatted_title ?>" <?= $selected ?>><?= ucwords($account->formatted_title) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                            <td><b>Type: </b><br>
